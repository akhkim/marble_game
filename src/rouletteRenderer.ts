...
export type RenderParameters = {
  ...
  teamFinished: Map<string, number>;
  teamWinners: string[];
};
...
export class RouletteRenderer {
  ...
  private async _load(): Promise<void> {
    const loadPromises =
      [
        { name: 'Andy', imgUrl: new URL('../assets/images/andy.png', import.meta.url) },
        { name: 'Michael', imgUrl: new URL('../assets/images/michael.png', import.meta.url) },
        { name: 'Leo', imgUrl: new URL('../assets/images/leo.png', import.meta.url) },
        { name: 'Kerry', imgUrl: new URL('../assets/images/kerry.png', import.meta.url) },
        { name: 'Robert', imgUrl: new URL('../assets/images/robert.png', import.meta.url) },
      ].map(({ name, imgUrl }) => {
        return (async () => {
