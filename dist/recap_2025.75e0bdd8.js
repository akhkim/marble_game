...
})({"aE53m":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "30d64a4275e0bdd8";
"use strict";
...
},{}],"goPQB":[function(require,module,exports,__globalThis) {
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
var _scrollSmoother = require("gsap/ScrollSmoother");
var _recap2025Data = require("./recap-2025-data");
const setNumbers = ()=>{
    const targets = document.querySelectorAll('[data-prop]');
    targets.forEach((elem)=>{
        const key = elem.getAttribute('data-prop');
        if (key && (0, _recap2025Data.data).hasOwnProperty(key)) {
            const value = (0, _recap2025Data.data)[key];
...
const titlePage = ()=>{
    ...
    (0, _gsap.gsap).set(marble, {
        x: startPointRect.x + startPointRect.width / 2 - 12,
        y: startPointRect.y + startPointRect.height / 2 - 9,
        opacity: 1
    });
    (0, _gsap.gsap).set('div.square', {
        rotate: 0
    });
...
const peoplePage = ()=>{
    const pPage = document.querySelector('#people-page');
    const video = document.querySelector('video#people-video');
    const tl = (0, _gsap.gsap).timeline();
    loadVideo(video, tl);
    const peopleCount = pPage.querySelector('.people-count');
    const countryCount = pPage.querySelector('.country-count');
    ...
    tl.fromTo(peopleCount, {
        ...
        duration: 100,
        onUpdate: ()=>{
            peopleCountValue.innerHTML = comma(Math.round(numbersAppear.peopleCountProgress * (0, _recap2025Data.data).people));
        }
    }, '>').to(peopleCount, {
        delay: 100,
        duration: 400,
        ...
        ease: 'power4.out',
        opacity: 1
    }, '>-200').to(numbersAppear, {
        countryCountProgress: 1,
        duration: 200,
        onUpdate: ()=>{
            countryCountValue.innerHTML = comma(Math.round(numbersAppear.countryCountProgress * (0, _recap2025Data.data).country));
        }
    }, '<').to(pPage, {
        delay: 900,
        autoAlpha: 0,
...
const executionPage = ()=>{
    const ePage = document.querySelector('#execution-page');
    const video = document.querySelector('video#execution-video');
    const startCountValue = ePage.querySelector('[data-prop="startCount"]');
    const tl = (0, _gsap.gsap).timeline();
    loadVideo(video, tl);
    const numbersAppear = {
    ...
    tl.to(numbersAppear, {
        ...
        onUpdate: ()=>{
            startCountValue.innerHTML = comma(Math.round(numbersAppear.startCountProgress * (0, _recap2025Data.data).startCount));
        }
    }, 0).to(ePage, {
        autoAlpha: 0,
        duration: 100
...
const dateTimePage = ()=>{
    const dPage = document.querySelector('#date-hours-page');
    const hours = document.querySelector('#hour-content');
    const dates = document.querySelector('#date-content');
    const hoursFromValue = hours.querySelector('[data-prop="busiestTimeFrom"]');
    const hoursToValue = hours.querySelector('[data-prop="busiestTimeTo"]');
    const monthValue = dates.querySelector('[data-prop="busiestDateMonth"]');
    const dateValue = dates.querySelector('[data-prop="busiestDateDate"]');
    const tl = (0, _gsap.gsap).timeline();
    ...
    tl.fromTo(numbersProgress, {
        ...
        duration: 100,
        onUpdate: ()=>{
            hoursFromValue.innerHTML = String(Math.floor((0, _recap2025Data.data).busiestTimeFrom * numbersProgress.hoursProgress));
            hoursToValue.innerHTML = String(Math.floor((0, _recap2025Data.data).busiestTimeTo * numbersProgress.hoursProgress));
        }
    }, 0);
    tl.fromTo(hours, {
        autoAlpha: 0,
        ...
        ease: 'power3.out',
        onUpdate: ()=>{
            monthValue.innerHTML = String(Math.floor(numbersProgress.datesProgress * (0, _recap2025Data.data).busiestDateMonth));
            dateValue.innerHTML = String(Math.floor(numbersProgress.datesProgress * (0, _recap2025Data.data).busiestDateDate));
        }
    }, '<');
    tl.fromTo(dPage.querySelector('div.hour.hand'), {
        ...
        rotation: 390,
        duration: 1000
    }, 0).fromTo(dPage.querySelector('div.hand.minute'), {
        transformOrigin: 'center bottom',
        rotation: 0
    }, {
        rotation: 3600,
...
const marbleCountPage = ()=>{
    const mPage = document.querySelector('#marble-count-page');
    const marbleCount = mPage.querySelector('[data-prop="marbleCount"]');
    const containers = mPage.querySelector('#containers');
    const trains = mPage.querySelector('#trains');
    const cubes = [];
    for(let i = 0; i < 34; i++){
    ...
    const totalProgress = 3900;
    (0, _gsap.gsap).fromTo(containers, {
        x: 500
    }, {
        ease: 'none',
        x: `-=${3900}`,
...
const coffeePage = ()=>{
    const cPage = document.querySelector('section#coffee-page');
    const img = cPage.querySelector('img');
    const content = cPage.querySelector('div.content');
    const coffeeCountValue = content.querySelector('[data-prop=coffeeBuyer]');
    const numbersProgress = {
        progress: 0
    };
    const tl = (0, _gsap.gsap).timeline().fromTo(numbersProgress, {
        progress: 0
    }, {
        progress: 1,
        duration: 200,
        onUpdate: ()=>{
            coffeeCountValue.innerHTML = String(Math.round(numbersProgress.progress * (0, _recap2025Data.data).coffeeBuyer));
        }
    }, 0).to(numbersProgress, {
        progress: 1,
        duration: 800
    });
    tl.fromTo(img, {
...
const init = ()=>{
    ...
    (0, _gsap.gsap).registerPlugin((0, _scrollSmoother.ScrollSmoother));
    (0, _scrollSmoother.ScrollSmoother).create({
        smooth: 1,
        effects: true,
        smoothTouch: 0.1
    });
    //
    const sections = (0, _gsap.gsap).utils.toArray('section');
    (0, _gsap.gsap).set(sections[0], {
        autoAlpha: 1
    });
    const peopleVideo = document.querySelector('#people-video');
    ...
    //   }
    // });
    document.querySelector('#statDate').innerHTML = (0, _recap2025Data.data).date;
...
},{"gsap":"9F7Z6","gsap/ScrollTrigger":"372oo","gsap/ScrollSmoother":"6GH8O","./recap-2025-data":"hlDnJ"}],"9F7Z6":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hlDnJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["aE53m","goPQB"], "goPQB", "parcelRequire5cc2", {})

//# sourceMappingURL=recap_2025.75e0bdd8.js.map
